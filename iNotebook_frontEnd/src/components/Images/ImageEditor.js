  ...
  return (
    <div>
      <div className='mb-2'>
        ...
        <button className='btn btn-danger my-2 mx-3' type='button' role='button' onClick={handleDelete} style={{position: 'relative', left: '0px', top: '0px'}}>Delete Images<i class="fa-solid fa-trash-can ms-2"></i></button>
